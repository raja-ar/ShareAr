...
import com.raja.shareArFront.chatview.ChatMsgEntity;
import com.raja.shareArFront.chatview.ChatMsgViewAdapter;
...
public class RoomHomeFragment extends Fragment{
     ...
     * Faked data
     */
    private String[] nameArray = new String[]{"ShareAr"};
    ...
    private void receive(){
        ...
        ChatMsgEntity entity = new ChatMsgEntity("ShareAr", getDate(), receiveString, ChatMsgEntity.MsgType.Receive);
