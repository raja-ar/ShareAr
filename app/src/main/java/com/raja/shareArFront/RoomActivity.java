...
import com.raja.shareArFront.roomview.ShareArImageView;
import com.raja.shareArFront.roomview.ShareArLayout;
import com.raja.shareArFront.roomview.ShareArLayout.OnItemClickListener;
import com.raja.shareArFront.roomview.ShareArLayout.OnItemSelectedListener;
...
public class RoomActivity extends Activity implements OnItemSelectedListener, OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ShareArLayout sharearMenu = (ShareArLayout)findViewById(R.id.main_sharear_layout);
        sharearMenu.setOnItemSelectedListener(this);
        sharearMenu.setOnItemClickListener(this);
        ...
        if(count != 0)
            selectedTextView.setText("Name:"+((ShareArImageView)sharearMenu.getSelectedItem()).getName());
...
//    }
    private void addOneRoom(String rid, String name){
        ShareArLayout sharearLayout = (ShareArLayout) findViewById(R.id.main_sharear_layout);
        ShareArImageView newItem = new ShareArImageView(mContext);
        newItem.setImageResource(R.drawable.icon_room);
        newItem.setRid(rid);
        newItem.setName(name);
        sharearLayout.addView(newItem);
    }
